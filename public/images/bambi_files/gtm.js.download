...
"resource": {
  ...
  "rules":[
    ...
    [["if",1],["add",11,14]],
    [["if",1,14],["add",16]],
    [["if",1,2],["block",0,1,4,5,6,7,8,12,13,14,15]]]
},
"runtime":[
[],[]
]};
...
var rc={},sc=null;rc.o="GTM-P5GCKB";var tc=null,uc="//www.googletagmanager.com/a?id="+rc.o+"&cv=43",vc={},wc={},xc=B.currentScript?B.currentScript.src:void 0;var yc=function(){},zc=function(a){return"function"==typeof a},Ac=function(a){return"string"==wa(a)},Bc=function(a){return"number"==wa(a)&&!isNaN(a)},Cc=function(a){return Math.round(Number(a))||0},Dc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},Ec=function(a){var b=[];if(pa(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},Fc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},Gc=function(a,b){if(!Bc(a)||!Bc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
